...
public:
	...
	bool GET(IN IHttpContext * context)
	{
		...
		//inclusion check for only php files
	...
	guard_isapi()
	{
		...
		//and errrr the fact is that SQL is a context-free language, how am i supposed to detect that thing with a REGULAR! expression?....
